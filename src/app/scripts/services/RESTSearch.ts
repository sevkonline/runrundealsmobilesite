/**
 * Module initializes rest service RESTSearch
 */
import {
    Injectable
} from '@angular/core';
...
class RESTSearch {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("RESTSearch.request.headers"),
            params: this.entityAPI.get("RESTSearch.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "RESTSearch"
            }
        };
