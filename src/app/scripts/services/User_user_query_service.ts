/**
 * Module initializes rest service User_user_query_service
 */
import {
    Injectable
} from '@angular/core';
...
class User_user_query_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("User_user_query_service.request.headers"),
            params: this.entityAPI.get("User_user_query_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "User_user_query_service"
            }
        };
...
*/
export {
    User_user_query_service as ExportedClass
};