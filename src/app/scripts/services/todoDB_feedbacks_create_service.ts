/**
 * Module initializes rest service todoDB_feedbacks_create_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class todoDB_feedbacks_create_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/db/collections/feedbacks",
            method: "post",
            headers: this.entityAPI.get("todoDB_feedbacks_create_service.request.headers"),
            params: this.entityAPI.get("todoDB_feedbacks_create_service.request.query"),
            data: this.entityAPI.get("todoDB_feedbacks_create_service.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "todoDB_feedbacks_create_service"
            }
        };
...
*/
export {
    todoDB_feedbacks_create_service as ExportedClass
};