/**
 * Module initializes rest service RESTlikeupdate
 */
import {
    Injectable
} from '@angular/core';
...
class RESTlikeupdate {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "put",
            headers: this.entityAPI.get("RESTlikeupdate.request.headers"),
            params: this.entityAPI.get("RESTlikeupdate.request.query"),
            data: this.entityAPI.get("RESTlikeupdate.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "RESTlikeupdate"
            }
        };
...
*/
export {
    RESTlikeupdate as ExportedClass
};