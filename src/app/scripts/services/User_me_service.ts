/**
 * Module initializes rest service User_me_service
 */
import {
    Injectable
} from '@angular/core';
...
class User_me_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("User_me_service.request.headers"),
            params: this.entityAPI.get("User_me_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "User_me_service"
            }
        };
...
*/
export {
    User_me_service as ExportedClass
};