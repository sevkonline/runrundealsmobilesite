/**
 * Module initializes rest service RESTbyCategory
 */
import {
    Injectable
} from '@angular/core';
...
class RESTbyCategory {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("RESTbyCategory.request.headers"),
            params: this.entityAPI.get("RESTbyCategory.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "RESTbyCategory"
            }
        };
...
*/
export {
    RESTbyCategory as ExportedClass
};