/**
 * Module initializes rest service RESTFeatured
 */
import {
    Injectable
} from '@angular/core';
...
class RESTFeatured {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("RESTFeatured.request.headers"),
            params: this.entityAPI.get("RESTFeatured.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "RESTFeatured"
            }
        };
