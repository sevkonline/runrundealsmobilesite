/**
 * Module initializes rest service restapi
 */
import {
    Injectable
} from '@angular/core';
...
class restapi {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("restapi.request.headers"),
            params: this.entityAPI.get("restapi.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "restapi"
