/**
 * Module initializes rest service primedeals
 */
import {
    Injectable
} from '@angular/core';
...
class primedeals {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("primedeals.request.headers"),
            params: this.entityAPI.get("primedeals.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "primedeals"
            }
        };
